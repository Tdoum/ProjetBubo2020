...
#define __Enregistrement_h__
	...
	class Enregistrement
	{
		...
		void setGeolocalisation(char aLatitude_[10], char aLongitude[10], char aAltitude[4]);
		...
		/// </summary>		
				void getGeolocalisation(char aLatitude_[10], char aLongitude[10], char aAltitude[4]);
