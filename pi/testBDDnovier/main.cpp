...
int id=5;
	...
	Enregistrement * unEnregistrement = new Enregistrement( aAlbedo,  aFluxLum,  aIdEnregistrement,  aIdRaspberry,  aTypeAmpoule, aTypeLampadaire,  aHauteur,  aLatitude,  aLongitude, aAltitude,  aNbImages,  aAgglo, aRue,  aUlor,  aDate,  aNotes,  puissance) ;
...
//	char longitude[10];
    ...
    laBDD.modifierEnregistrement(id,puissance,albedo,fluxLum,idEnregistrement,idRaspberry,typeAmpoule,typeLampadaire,hauteur,latitude,longitude,altitude ,nbImages,agglo,rue,ulor,date,notes);
