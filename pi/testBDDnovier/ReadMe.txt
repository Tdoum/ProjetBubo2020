========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet testBDDRizetto
========================================================================

AppWizard a créé cette application testBDDRizetto pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application testBDDRizetto.


testBDDRizetto.vcxproj
...
testBDDRizetto.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé testBDDRizetto.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
