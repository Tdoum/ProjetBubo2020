...
void lireListeAmpoule()
{
	...
	ifstream fichier("/home/pi/bdd/listeAmpoule.txt", ios::in);
	string ligne;
...
void lireListeLampadaire()
{
    ifstream fichier("/home/pi/bdd/listeLampadaire.txt", ios::in);
                string ligne;
                vector<string>::iterator it;
	vector<string> tableau;
	if(fichier)  // si l'ouverture a réussi
...
void lireListeULOR()
{
    ifstream fichier("/home/pi/bdd/listeULOR.txt", ios::in);
    string ligne;
    vector<string>::iterator it;
	vector<string> tableau;
	if(fichier)  // si l'ouverture a réussi
...
void lireListeAlbedo()
{
    ifstream fichier("/home/pi/bdd/listeAlbedo.txt", ios::in);
    vector<string> tableau;
    string ligne;
