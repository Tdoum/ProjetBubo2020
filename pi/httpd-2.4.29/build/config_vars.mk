...
ab_LDFLAGS = -L/usr/local/lib -lssl -lcrypto -lrt -lcrypt -lpthread -ldl
...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /home/pi/httpd-2.4.29/srclib/apr-util/libaprutil-1.la /home/pi/httpd-2.4.29/srclib/apr-util/xml/expat/libexpat.la /home/pi/httpd-2.4.29/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
HTTPD_VERSION = 2.4.29
HTTPD_MMN = 20120211
abs_srcdir = /home/pi/httpd-2.4.29
...
APR_INCLUDEDIR = /home/pi/httpd-2.4.29/srclib/apr/include
APR_VERSION = 1.5.2
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /home/pi/httpd-2.4.29/srclib/apr-util/include
APU_VERSION = 1.5.4
