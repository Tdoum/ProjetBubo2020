...
int main()
{
		...
		std::vector<showUserChoice*> laListeEnregistrements=leCollecteur->getlisteEnregistrements();
		cout << HTTPHTMLHeader();
		cout<<"{\"showUserChoice\":\n\t[";
		//----------------------------
		...
		//printf("\n\t]\n}");
		//----------------------------
		for (std::vector<showUserChoice*>::iterator it = laListeEnregistrements.begin() ; it != laListeEnregistrements.end(); ++it)
		{
			cout<<"\n\t\t{";
			/* string lamp;
  			string streetlight;
